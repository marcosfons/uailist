...
class NewSupermarketScreen extends StatefulHookConsumerWidget {
  ...
  @override
  NewSupermarketScreenState createState() => NewSupermarketScreenState();
}

class NewSupermarketScreenState extends ConsumerState<NewSupermarketScreen> {
  late final _controller = ref.read(supermarketController);

  SupermarketsCompanion newSupermarket = SupermarketsCompanion(
